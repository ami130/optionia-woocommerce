 ...
 * ## Why a native picker
 *
 * `datetime-local` rather than `datetime`, which no browser implements. Local means *the store’s* local, and the server re-validates against the merchant’s timezone.
 *
 ...
 *
 * ## Why `type="datetime-local"` rather than a text input
 *
...
?>
<div class="optionia-option optionia-option--datetime-picker optionia-option--cols-<?php echo esc_attr( (string) $optionia_display['columns'] ); ?><?php echo $optionia_display['collapsed'] ? ' optionia-option--collapsed' : ''; ?>" data-optionia="option" data-optionia-option="<?php echo esc_attr( $optionia_id ); ?>">
