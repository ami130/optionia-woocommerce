...
SUITE_ROOT="tests/unit tests/js"
...
WIRE='tests/fixtures/shared/assignment-wire.json'
...
SPEC='tests/fixtures/shared/PRICING-SPEC.md'
...
EXPECTED_RULES_SHA='fa9e456f216576d9326c21800a856f65b639152a172acd176d20320fe73ab585'
